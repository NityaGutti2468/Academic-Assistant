...
Student: {student['name']}
Fee Type: {f['fee_type']}
Original Amount: Rs.{f['amount']}
Late Penalty: Rs.{late_penalty} (Rs.50/day for {days_overdue} days)
...
def get_student_fees(student_id):
    ...
    return {
        "message": f"You have {len(student_fees)} pending fee(s) totaling Rs.{total_due} (including late penalties).",
        "data": detailed_fees
    }
